...
// ******************************************************************************************
//	@file Name: ITGCInfo_dialog.hpp
//	@file Author: Lodac

#include "ITGCInfo_defines.hpp"
#define X_safezone 
...
class ITGCInfoD
{
	...
	{	
		...
		{
			idc = 10032;
			text = "ITGCommunity.com Information";
		...
		{
			idc = ITGCInfo_Server_Info;
			type = CT_STRUCTURED_TEXT;
			size = 0.040;
			text = "ITGC Wasteland Altis";
		...
		{
			idc = ITGCInfo_General_Info_BG;
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: ITGCommunity.com TeamSpeak: ts.ITGCommunity.com";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
		...
		{
			idc = ITGCInfo_Stats_Title_BG;
			text = "ITGC Player & Server Stats";
			x = "15.1 * (((safezoneW / safezoneH) min 1.2) / 40)";
