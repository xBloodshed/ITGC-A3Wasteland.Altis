...
_confirmMsg = _confirmMsg + format ["<br/><t font='EtelkaMonospaceProBold'>1</t> x M2A1 Slammer"];
...
{	// Include vehicle store cooldown timer
	...
	if (_timeLeft > 0) then
	{
		...
		_para = createVehicle ["B_Parachute_02_F", _posplr, [], 0, ""];
			_spwnveh = "B_MBT_01_cannon_F" createVehicle _posplr;
