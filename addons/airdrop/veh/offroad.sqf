...
_confirmMsg = format ["This airdrop will deduct $5,000 from your bank account<br/>"];
_confirmMsg = _confirmMsg + format ["<br/><t font='EtelkaMonospaceProBold'>1</t> x Armed Offroad"];
...
{	// Include vehicle store cooldown timer
	...
	if (_timeLeft > 0) then
	{
		...
		_para = createVehicle ["B_Parachute_02_F", _posplr, [], 0, ""];
			_spwnveh = "B_G_Offroad_01_armed_F" createVehicle _posplr;
