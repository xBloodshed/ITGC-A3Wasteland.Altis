...
_confirmMsg = format ["This airdrop will deduct $30,000 from your bank account<br/>"];
_confirmMsg = _confirmMsg + format ["<br/><t font='EtelkaMonospaceProBold'>1</t> x Hunter HMG .50"];
...
{	// Include vehicle store cooldown timer
	...
	if (_timeLeft > 0) then
	{
		...
		_para = createVehicle ["B_Parachute_02_F", _posplr, [], 0, ""];
			_spwnveh = "B_MRAP_01_hmg_F" createVehicle _posplr;
